        ...
        <div class="token-info-wrap">
          <div class="div1">
            ...
            <div class="ify-div">
              ...
              <span class="unit fz-12">{{ usdTokenName }}</span>
            </div>
          </div>
          <div class="div1">
          ...
          <div class="div1">
            <span class="ify-span">{{$t('Data.Data.Token.BuyBackFundBalance')}}({{ usdTokenName }})</span>
            <div class="ify-div">
  ...
  computed:{
    ...
    subOptions () {
      return [
        ...
        {value: 1, text: `BTC/${getUSDTokenName()}`, token: Token.BTC},
        {value: 2, text: `ETH/${getUSDTokenName()}`, token: Token.ETH},
      ]
    },
    subToken () {
