<template>
  <van-popup class="derify-popup" v-model="showPopup" round :closeable="false" @close="close">
    <div class="unwind-popup system-popup">
      <div class="system-popup-title">存入bDRF</div>
      <div>
        <div>
        ...
        <div class="system-popup-num">
          <span class="popup-span1">可存入：1234567.00000000 bDRF</span>
          <span class="popup-span2">全部存入</span>
        </div>
      </div>
      <div class="system-popup-buttons">
        <div class="system-popup-button cancel" @click="close">取消</div>
        <div class="system-popup-button confirm" @click="close">存入</div>
      </div>
    </div>
  </van-popup>
</template>
