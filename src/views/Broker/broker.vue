        ...
        <div class="market-popup">
          ...
          <div class="income-div">
            <div class="taday-div">
              ...
              <span class="span2 fz-11">{{$t('Broker.Broker.Account.DailyEarning')}} ( {{ usdTokenName }} )</span>
            </div>
            <div class="taday-div">
              <DecimalView :value="broker.accumulatedReward | fck(-8,2)" className="span1"></DecimalView>
              <span class="span2 fz-11">{{$t('Broker.Broker.Account.AccumulatedEarning')}} ( {{ usdTokenName }} )</span>
            </div>
          </div>
        ...
        <div class="unwind-popup system-popup">
          ...
          <template v-if="isLogin">
            ...
            <div class="derify-big-btn">
              <a class="fc-yellow fz-15" href="https://docs.google.com/forms/d/e/1FAIpQLSfXtFTznW1COzNFebfNGjdRKfcNdG0zNjM7GXasajJOLA5v_A/viewform" target="_blank">{{$t("Broker.Apply.GetTestEDRF")}}</a>
            </div>
          </template>
